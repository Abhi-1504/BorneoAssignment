...
def sync_data(request_time=None):
    ...
    try:
        ...
        if sync_resolver['Synchronizing']:
            ...
            'Synchronizing already in Progress! Please wait...',
            409)
        ...
        # For request recieved for time less than the half of periodic sync of DB
            ...
            response = create_respone(False,
            'Syncronization recently completed. Try again later',
            406)
        ...
        # For triggering synchronization
            ...
            'Syncronization completed Successfully',
            200)
